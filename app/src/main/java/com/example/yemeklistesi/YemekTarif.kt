...
class YemekTarif : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            var gelenBilgi = YemekTarifArgs.fromBundle(it).bilgi
            if (gelenBilgi.equals("menudengeldim")){
                yemekIsmıText.setText("")
                yemekMalzemeleriText.setText("")
                button.visibility = View.VISIBLE

                val gorselSecmeArkaPlani = BitmapFactory.decodeResource(context?.resources,R.drawable.resim_ekle)
                imageView.setImageBitmap(gorselSecmeArkaPlani)
            } else{
                button.visibility = View.INVISIBLE

                val secilenId = YemekTarifArgs.fromBundle(it).id
                ...
                context?.let{
                    try {
                        ...
                        while (cursor.moveToNext()){
                            yemekIsmıText.setText(cursor.getString(yemekIsmiIndex))
    ...
    fun kaydet (view: View) {
        val yemekIsmi = yemekIsmıText.text.toString()
        ...
        if (secilenBitmap != null){
            ...
            val action = YemekTarifDirections.actionYemekTarifToYemekList()
